...
// (in-package service_client_server.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'service_client_server/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'service_client_server/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'service_client_server/AddTwoInts'; }
};
